...
/**
 * Importateur de recettes via l'API TheMealDB.
 * <p>
 * Récupère des recettes complètes (nom, catégorie, région, ingrédients,
 * mesures, instructions) depuis TheMealDB et les importe dans le catalogue
...
public class MealDbImporter {
    ...
    /**
     * Lance l'import des recettes depuis TheMealDB.
     *
